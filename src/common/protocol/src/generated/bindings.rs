...
pub struct Checker {
    ...
    >,
    pub buffer: [::std::os::raw::c_uchar; 14usize],
    pub pos: ::std::os::raw::c_uint,
    pub out_buffer: [::std::os::raw::c_uchar; 10usize],
}
#[test]
...
extern "C" {
    #[link_name = "\u{1}_ZN7Checker4initEPvPFiS0_EPFvS0_hEPFhS0_E"]
    pub fn Checker_init(
        this: *mut Checker,
...
impl Checker {
    ...
    pub unsafe fn init(
        ...
        Checker_init(self, data, inner_available, inner_send, inner_read)
    }
}
...
extern "C" {
    #[link_name = "\u{1}_ZN8Protocol4initEPvPFiS0_EPFvS0_hEPFhS0_E"]
...
impl Protocol {
    ...
    pub unsafe fn init(
        ...
        Protocol_init(self, data, inner_available, inner_send, inner_read)
    }
}
extern "C" {
